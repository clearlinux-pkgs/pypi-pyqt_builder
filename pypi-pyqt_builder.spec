...
Source0  : https://files.pythonhosted.org/packages/21/6c/685981114cb350f2f8e4a0827aa7f60f142e15816aa48f3204e5a1e2578c/PyQt-builder-1.14.1.tar.gz
...
%prep
%setup -q -n PyQt-builder-1.14.1
cd %{_builddir}/PyQt-builder-1.14.1
%patch1 -p1
pushd ..
cp -a PyQt-builder-1.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674943865
